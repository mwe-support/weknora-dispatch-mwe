...
type IndexInfo struct {
	// PreparedEmbedding is a verified output from a separate embedding stage.
	// nil uses the legacy embed-and-index path; a supplied vector is never recomputed.
	PreparedEmbedding []float32
