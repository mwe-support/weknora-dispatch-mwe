ALTER TABLE chunks ADD COLUMN faq_index_manifest TEXT NOT NULL DEFAULT '';
CREATE TABLE IF NOT EXISTS faq_index_writes (
    ...
    content_digest TEXT NOT NULL, source_ids TEXT NOT NULL, destination TEXT NOT NULL,
    state TEXT NOT NULL DEFAULT 'pending' CHECK (state IN ('pending', 'indexed', 'deleting', 'deleted')),
    estimated_bytes INTEGER NOT NULL DEFAULT 0 CHECK (estimated_bytes >= 0), storage_released BOOLEAN NOT NULL DEFAULT FALSE,
