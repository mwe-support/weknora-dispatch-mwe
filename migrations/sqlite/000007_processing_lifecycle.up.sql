CREATE TABLE processing_graph_writes (
...
CREATE INDEX idx_processing_graph_job ON processing_graph_writes(job_id, state);
CREATE INDEX idx_processing_graph_kb ON processing_graph_writes(tenant_id, knowledge_base_id, state);
