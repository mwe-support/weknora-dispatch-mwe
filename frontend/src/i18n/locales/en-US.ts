export default {
  ...
  auth: {
    ...
    passwordResetHint: 'Enter your registered email to receive a code. If the account exists, the code will arrive shortly.',
    sendVerificationCode: 'Send code',
    verificationCode: 'Verification code',
    verificationCodePlaceholder: 'Enter the 6-digit code',
    verificationCodeSent: 'If the account exists, a code has been sent',
    verificationCodeInvalid: 'Enter a valid 6-digit code',
    newPassword: 'New password',
    resetPassword: 'Reset password',
    passwordResetSuccess: 'Password reset. Sign in with your new password',
    passwordResetFailed: 'Password reset failed. Check the code and try again',
  ...
  datasource: {
    ...
    connectorDesc: {
      ...
      tencent_docs: 'Sync spaces, folders and documents through Tencent Docs MCP',
    ...
    field: {
      ...
      tencentDocsMcpTokenHint: 'Enter the token generated by the Tencent Docs MCP authorization flow. It can only read spaces and documents visible to that token.',
    ...
    resourceType: {
      ...
      tencentDocsSpace: 'Tencent Docs Space',
