export default {
  ...
  datasource: {
	fileRetry: {
	  label: '이번 재시도 계획', scheduled: '보상 재시도 예약됨', running: '보상 처리 중',
	  enqueue_failed: '큐 등록 실패, 재시도 계획 유지됨', completed: '보상 완료', needs_manual: '수동 조치 필요',
	  exhausted: '재시도 횟수 소진', paused: '일시 중지됨', attempt: '보상 회차 {n}', nextAt: '다음 실행 시간',
	},
  ...
  organization: {
    ...
    addMember: {
      button: '회원 추가',
      dialogTitle: '회원 추가',
      tipTenant: '구성원의 최소 단위는 워크스페이스입니다. 하나 이상의 워크스페이스를 선택하면 해당 워크스페이스의 모든 사용자가 이 스페이스에 접근할 수 있습니다.',
      searchTenant: '워크스페이스 선택',
      searchTenantPlaceholder: '워크스페이스 이름으로 검색...',
      searchTenantHint: '워크스페이스를 바로 여러 개 선택하거나 글자 수 제한 없이 검색할 수 있습니다. 기존 구성원은 자동으로 제외됩니다.',
      selectRole: '역할 할당',
      confirmBtn: '추가',
      success: '회원이 추가되었습니다.',
      failed: '추가 실패'
  ...
  auth: {
    ...
    passwordResetHint: '가입 이메일을 입력해 인증 코드를 받으세요. 계정이 있으면 곧 코드가 발송됩니다.',
    sendVerificationCode: '코드 보내기',
    verificationCode: '인증 코드',
    verificationCodePlaceholder: '6자리 코드 입력',
    verificationCodeSent: '계정이 있으면 인증 코드가 발송되었습니다',
    verificationCodeInvalid: '올바른 6자리 코드를 입력하세요',
    newPassword: '새 비밀번호',
    resetPassword: '비밀번호 재설정',
    passwordResetSuccess: '비밀번호가 재설정되었습니다. 새 비밀번호로 로그인하세요',
    passwordResetFailed: '비밀번호 재설정에 실패했습니다. 코드를 확인하고 다시 시도하세요',
