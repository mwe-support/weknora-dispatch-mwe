...
export default {
  ...
  datasource: {
	fileRetry: {
	  label: 'План повторных попыток', scheduled: 'Повторная попытка запланирована', running: 'Выполняется повторная попытка',
	  enqueue_failed: 'Ошибка очереди; план сохранён', completed: 'Повторная обработка завершена', needs_manual: 'Требуется действие вручную',
	  exhausted: 'Попытки исчерпаны', paused: 'Приостановлено', attempt: 'Попытка {n}', nextAt: 'Следующий запуск',
	},
    faqDescription: 'Для FAQ пока поддерживается только Tencent Docs: шаблоны CSV/TSV/XLSX/JSON и таблицы с вопросом и ответами. Разделяйте несколько ответов символами ##. Старые XLS сохраните как XLSX. Записи добавляются или объединяются по основному вопросу без удаления существующих FAQ. Ошибки содержат файл и номер строки.',
    ...
    scheduleWeekly: 'Еженедельно (вс, 02:00)',
    scheduleMonthly: 'Ежемесячно (1-го, 02:00)',
    ...
    scheduleHuman: {
      ...
      '12h': 'Каждые 12 часов',
      '24h': 'Ежедневно',
      weekly: 'Еженедельно (вс, 02:00)',
      monthly: 'Ежемесячно (1-го, 02:00)'
    },
    field: {
      appId: 'App ID',
  ...
  organization: {
    ...
    addMember: {
      ...
      tipTenant: 'Членство задаётся на уровне пространства: выберите одно или несколько пространств, и все их пользователи получат доступ.',
      searchTenant: 'Выбрать пространство',
      searchTenantPlaceholder: 'Поиск по имени пространства...',
      searchTenantHint: 'Можно сразу выбрать несколько пространств или искать по любому числу символов; уже добавленные пространства скрываются автоматически.',
  ...
  knowledgeEditor: {
    ...
    advanced: {
      ...
      questionGeneration: {
        ...
        countDescription: 'Количество вопросов на фрагмент документа (0–10). 0 отключает генерацию; по умолчанию выключено.',
  ...
  auth: {
    ...
    passwordResetHint: 'Введите почту регистрации. Если аккаунт существует, код скоро придёт на почту.',
    sendVerificationCode: 'Отправить код',
    verificationCode: 'Код подтверждения',
    verificationCodePlaceholder: 'Введите 6-значный код',
    verificationCodeSent: 'Если аккаунт существует, код отправлен',
    verificationCodeInvalid: 'Введите корректный 6-значный код',
    newPassword: 'Новый пароль',
    resetPassword: 'Сбросить пароль',
    passwordResetSuccess: 'Пароль сброшен. Войдите с новым паролем',
    passwordResetFailed: 'Не удалось сбросить пароль. Проверьте код и повторите попытку',
