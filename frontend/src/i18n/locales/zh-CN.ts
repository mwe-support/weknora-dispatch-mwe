export default {
  ...
  auth: {
    ...
    passwordResetHint: '输入注册邮箱获取验证码。若账户存在，验证码将在几分钟内发送。',
    sendVerificationCode: '发送验证码',
    verificationCode: '验证码',
    verificationCodePlaceholder: '输入6位验证码',
    verificationCodeSent: '若账户存在，验证码已发送',
    verificationCodeInvalid: '请输入6位数字验证码',
    newPassword: '新密码',
    resetPassword: '重置密码',
    passwordResetSuccess: '密码已重置，请使用新密码登录',
    passwordResetFailed: '密码重置失败，请检查验证码后重试',
